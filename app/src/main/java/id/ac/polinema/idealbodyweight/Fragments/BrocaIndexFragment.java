...
public class BrocaIndexFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final RadioGroup genderGroup = view.findViewById(R.id.radio);
        final EditText heightText = view.findViewById(R.id.heightInput);
            ...
            public void onClick(View view) {
                if(mListener != null){
                    ...
                    if((checkId != -1) && !TextUtils.isEmpty(heightString)){
                        ...
                        BrocaIndex bi = new BrocaIndex(gender, height);
                        mListener.onCalculateBrocaIndexClick(bi.getIndex());
                    }
                }
                else{
    ...
    public interface OnFragmentInteractionListener {
        void onCalculateBrocaIndexClick(float index);
    }
}
